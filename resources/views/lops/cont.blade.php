...
<div class="row align-items-strech">
    ...
    <div class="card m-1 bg-my1" style="width: 25rem;">
        ...
        <h5 class="card-title"><p class="bg-my-h">目的or夢：</p>{{$lop->dream}}</h5>
        <p class="card-text"><p class="bg-my-h">なんでその目的or夢？</p>{!! nl2br(e(Str::limit($lop->dreamwhy, 100))) !!}</p>
        <p class="card-text"><p class="bg-my-h">目的or夢のためにやっていること：</p>{!! nl2br(e(Str::limit($lop->dreamdo, 300))) !!}</p>
        <h5 class="card-title"><p class="bg-my-h">現在していること：</p>{{$lop->nowdo}}</h5>
        <p class="card-text"><p class="bg-my-h">なんで現在それをやっているのか：</p>{!! nl2br(e(Str::limit($lop->dreamwhy, 300))) !!}</p>
